                        ...
                        <Modal.Body>
                            <form>
                                ...
                                <div class="form-group mt-3">
                                    <input type="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Biography" />
                                </div>
                                <div class="form-group mt-3">
                                    <input type="role" class="form-control" id="exampleInputRole" aria-describedby="RoleHelp" placeholder="Enter Role" />
                                </div>
                                <div class="form-group mt-3">
